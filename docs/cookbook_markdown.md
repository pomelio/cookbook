...
## side bar
> The side bar is at left side of a page. It is based on a [bootstrap Navbar](https://getbootstrap.com/docs/5.0/components/navbar/). The content of the side bar is from a json file name ![github](/public/images/github-30.png) [/docs/side_bar.json](https://github.com/pomelio/cookbook/blob/main/docs/side_bar.json).
...
### bootstrap NavBar
> The Navbar template is located at ![github](/public/images/github-30.png) [/docs/sidebar.mustache](https://github.com/pomelio/cookbook/blob/main/docs/sidebar.mustache)
...
the section template ![github](/public/images/github-30.png) [/docs/sidebar_section.mustache](https://github.com/pomelio/cookbook/blob/main/docs/sidebar_section.mustache)
...
## markdown page ![github](/public/images/github-30.png) [/bin/markdown.wby](https://github.com/pomelio/cookbook/blob/main/bin/markdown.wby)
```
