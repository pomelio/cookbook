...
<div class="flex flex-col items-end p-4 my-6 mx-4 bg-white rounded-lg shadow md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
    ...
    <label for="message" class="self-start block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your message</label>
    ...
    <div class="basis-1/4">
        <button type="button" class="px-3 py-2 text-xs font-medium text-center text-gray-700 hover:bg-gray-100 dark:text-gray-300  dark:hover:text-white dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save</button>
    </div>
</div>
`;
        return html;
